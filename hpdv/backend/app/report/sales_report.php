...
if (!isset($_GET['action']) || !isset($_GET['id'])) {
    ...
    if ($action === "print_sale") {
        ...
        <tr>
            <td width="33%" style="text-align: left;">Compra #' . $sale_id . '</td>          
            <td width="33%" style="text-align: center;">NextPulse Engenharia
                <br>                
                www.nextpulse.com.br
            </td>
             <td width="33%" style="text-align: right;">Compra #' . $sale_id . '</td>   
