...
<body>
  <div class="d-none d-sm-block">
    <nav class="navbar navbar-expand-lg navBarBackground">
      <a class="navbar-brand navoptions" href="?pagina="><img src="../assets/img/desklogo.png" class="classImage" alt=""> Next Pulse Engenharia</a>
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item active">
            <a class="nav-link navoptions" href="?pagina=graficosPainel=" >Graficos</a>
          </li>
          <li class="nav-item">
            <a class="nav-link navoptions" href="?pagina=cadastrovendas">Compras Realizadas</a>
          </li>
          <li class="nav-item">
    ...
    <div class="row" id="dashBoard">
        ...
        <div class="sidebar-sticky">
          <ul class="nav flex-column">
            <li class="nav-item">
              ...
              <img src="../assets/img/chart-bar-solid.svg"  class="icon">  Graficos
              </a>
            </li>

            <li class="nav-item">

              <a class="nav-link navoptionsblack" href="cadastrovendas">
              <img src="../assets/img/dollar-sign-solid.svg" class="icon"> Cadastro de Vendas
              </a>
            ...
            <li class="nav-item">
              ...
              <a class="nav-link navoptionsblack" href="cadastroclientes">
              <img src="../assets/img/users-solid.svg"  class="icon">   Cadastro de Clientes
              </a>
      ...
      <div class="d-block d-sm-none container-fluid">
        <nav class="navbar fixed-top navbar-dark flex-md-nowrap p-0 colorMobile">
          <div class="styleDrop">
          <img src="../assets/img/desklogo.png" class="classImage" alt=""> 
            ...
            <div class="dropdown-menu drop" aria-labelledby="dropdownMenuLink" id="conteudoNavbarSuportado">
              ...
              <li class="nav-item">
                ...
                <a class="nav-link drop" href="cadastroclientes"> 
              ...
              <li class="nav-item">
                ...
                <a class="nav-link drop" href="cadastrovendas">
