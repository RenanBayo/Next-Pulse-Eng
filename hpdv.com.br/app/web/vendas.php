...
<?php require '../layouts/menu.php' ?>
    <main>
        ...
        <?php foreach ($result_product as $product) : ?>
            <option value="<?php echo $product->id ?>" data-id="<?= $product->id ?>" data-price="<?= $product->preco_venda_produto ?>" data-img="<?= $product->imagem_produto ?>" data-qnt="<?= $product->quantidade_produto ?>">
                <?php echo $product->nome_produto ?>
            </option>
        <?php endforeach; ?>  
    </select>
    <a href="cadastro-produto.php" class="btn btn-success btn-lg mt-3" target="_blank"><h5>Novo Produto</h5></a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="container-operation">
                            ...
                            <button class="btn btn-lg btn-danger" onclick="cancelSale()">Cancelar Compra</button>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div>
                                <div class="row">
                                    <div class="form-floating mb-3">
                                        ...
                                        <label for="total_sale">Total da Compra</label>
                                    </div>
                                </div>
                                ...
                                <div>
                                    <div class="form-floating mt-3" id="pix_transaction_field" style="display: none;">
                                        <input type="text" class="form-control" id="cd_transaction_pix" placeholder="Código de transação ou Chave Pix">
                                ...
                                <div class="mt-3">
                                    <button class="btn btn-primary btn-lg" id="closeSaleModal">Finalizar Compra</button>
                                    <button type="button" class="btn btn-secondary btn-lg" onclick="backToSale()">Voltar para Compra</button>
                                </div>
                            </div>
                        </form>
                    </div>
